  ...
  static Future<void> update(
    ...
    try {
      ...
      UpdateManager.checkUpdate(context, entity,
          //可以自定义头部图片，按钮主题色，进度条颜色，标题,标题距离头部图片的高度,apk文件名,是否显示中文文本
          // config: UpdateConfig(
              // apkName: 'test.apk',
